...
class NP implements KeyListener
{
	...
	{
		save = new Dialog(f,s);
		save.setSize(600,500);
		save.setLayout(null);

		Label lb = new Label("Save In : ",Label.LEFT);
		lb.setBounds(10,36,60,30);
		save.add(lb);

		Choice cc = new Choice();
		cc.setBounds(70,40,280,30);
		save.add(cc);

		List savelist = new List(5,false);
		savelist.setBounds(10,80,580,260);
		save.add(savelist);

				savelist.add("COPY");
				savelist.add("PASTE");
				savelist.add("CUT");
				savelist.add("WWWWWWWWWWWWWWWWWWWWW");
				savelist.add("CBA");
				savelist.add("ABC");
				savelist.add("COPY");
				savelist.add("PASTE");
		...
		Label ll = new Label("File Name:",Label.LEFT);
		ll.setBounds(10,346,80,50);
		save.add(ll);

		TextField fileName = new TextField();
		fileName.setBounds(90,360,500,25);
		save.add(fileName);

		Label ll2 = new Label("File Type:",Label.LEFT);
		ll2.setBounds(10,385,80,50);
		save.add(ll2);


		choice = new Choice();
		choice.add("All Files");
		choice.add("Java Source Files(*.java)");
		choice.add("Text Files(*.txt)");
		choice.setBounds(90,400,500,25);
		save.add(choice);

		saveButton = new Button("Save");
		saveButton.setBounds(345,440,120,30);
		save.add(saveButton);

		cancelSave = new Button("Cancel");
		cancelSave.setBounds(475,440,115,30);
		save.add(cancelSave);
		...
		gbc.fill = GridBagConstraints.HORIZONTAL;//VERTICAL;//HORIZONTAL;
		gbc.gridx = 0;
		gbc.gridy = 0;
		save.add(new Button("1"),gbc);

		//gbc.fill = GridBagConstraints.VERTICAL;
		gbc.gridx = 1;
		gbc.gridy = 1;
		save.add(new Button("2"),gbc);

		//gbc.fill = GridBagConstraints.VERTICAL;
		gbc.gridx = 2;
		gbc.gridy = 2;
		save.add(new Button("3"),gbc);*/
	}
		...
		/*li.addItemListener(new ItemListener()
			...
			li.addItemListener(new ItemListener(){
								public void itemStateChanged(ItemEvent ev)
								{
										...
										tafont.setFont(new Font("Calibri",1,34));
										tafont.setText(thisFont.toString());
										Label l = new Label();
										l.setFont(thisFont);
										l.setText("hello");
										l.setBounds(5,5,50,50);
										find.add(l);
